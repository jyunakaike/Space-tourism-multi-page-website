    ...
    return (
        <section className={styles['crew-container']}>
            <div className={styles['crew-wrapper']} >
                ...
                <div className={styles['crew-detail-wrapper']}>
                    {
                        (loading == false)
                            ?
                    ...
                    <div className={styles['crew-image-mobile']} >
                        {
                            (loading == false)
                                ?
                                < Image src={crew.images.png} layout="responsive" objectFit="contain" width={500} height={500} alt={`Images of ${crew.name}`} />
                                :
                                <div>loading...</div>
                        }
                    </div>
            ...
            <div className={styles['crew-image-desk']} >
                {
                    (loading == false)
                        ?
